...
export default function RegistrationForm() {
  ...
  return (
    <div>
		<p className="text-center mb-9 flex ml-24">Witamy w <p className="text-dark_coral ml-2">E</p>du<p className="text-dark_coral">S</p>wap!</p>
      <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Box sx={{ Width: 300 }}>
            <FormControl fullWidth>
              ...
              <Select
				...
				sx={{ width: "39ch", top: "-5px", transform: "translate(0, 12px) scale(1)" }}
                size="small"
              >
        ...
        <br />
		<p className="text-center  mb-6">Masz już konto? <Link to="/signup/login" className="text-dark_coral"> Zaloguj się</Link></p>
		<p className="ml-5 mt-2">
        <Button variant="contained" type="submit" sx={{backgroundColor: '#E85A4F', width:'39ch'}}>Zarejestruj się</Button>
		</p>
      </form>
    </div>
  );
